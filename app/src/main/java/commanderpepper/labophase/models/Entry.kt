...
sealed class Leader(val name: String, val set: Set, val cardId: String, val leaderColors: List<LeaderColor>, val blockNumber: Int = set.blockNumber) {
    ...
    object GOden : Leader(name = "G Oden", set = Set.OP01, cardId = "OP01-031", leaderColors = listOf(LeaderColor.Green))
    object UDoflamingo : Leader(name = "U Doflamingo", set = Set.OP01, cardId = "OP01-060", leaderColors = listOf(LeaderColor.Blue))
    object UPKaido : Leader(name = "UP Kaido", set = Set.OP01, cardId = "OP01-061", leaderColors = listOf(LeaderColor.Blue, LeaderColor.Purple))
    object UPCrocodile : Leader(name = "UP Crocodile", set = Set.OP01, cardId = "OP01-062", leaderColors = listOf(LeaderColor.Blue, LeaderColor.Purple))
    object PKing : Leader(name = "P King", set = Set.OP01, cardId = "OP01-091", leaderColors = listOf(LeaderColor.Purple))
    ...
    object GKuro : Leader(name = "G Kuro", set = Set.OP03, cardId = "OP03-021", leaderColors = listOf(LeaderColor.Green))
    object GYArlong : Leader(name = "GY Arlong", set = Set.OP03, cardId = "OP03-022", leaderColors = listOf(LeaderColor.Green, LeaderColor.Yellow))
    object PIceberg : Leader(name = "P Iceberg", set = Set.OP03, cardId = "OP03-058", leaderColors = listOf(LeaderColor.Purple))
    object BLucci03 : Leader(name = "B Lucci03", set = Set.OP03, cardId = "OP03-076", leaderColors = listOf(LeaderColor.Black))
    object BYLinlin : Leader(name = "BY Linlin", set = Set.OP03, cardId = "OP03-077", leaderColors = listOf(LeaderColor.Black, LeaderColor.Yellow))
    ...
    object GPDoflamingo : Leader(name = "GP Doflamingo", set = Set.OP04, cardId = "OP04-019", leaderColors = listOf(LeaderColor.Green, LeaderColor.Purple))
    object GBIssho : Leader(name = "GB Issho", set = Set.OP04, cardId = "OP04-020", leaderColors = listOf(LeaderColor.Green, LeaderColor.Black))
    object UBRebecca : Leader(name = "UB Rebecca", set = Set.OP04, cardId = "OP04-039", leaderColors = listOf(LeaderColor.Blue, LeaderColor.Black))
    object UYQueen : Leader(name = "UY Queen", set = Set.OP04, cardId = "OP04-040", leaderColors = listOf(LeaderColor.Blue, LeaderColor.Yellow))
    object PYCrocodile : Leader(name = "PY Crocodile", set = Set.OP04, cardId = "OP04-058", leaderColors = listOf(LeaderColor.Purple, LeaderColor.Yellow))
